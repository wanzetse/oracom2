            ...
            controller: {
                ...
                loadData: function (filter) {
                    ...
                    return $.grep(data, function (item) {
                        ...
                        return (!filter.individualSelected || item.individualSelected.indexOf(filter.individualSelected) > -1)
                            && (!filter.individualEmail || item.individualEmail.toLowerCase().indexOf(filter.individualEmail.toLowerCase()) > -1)
                            && (!filter.individualDescription || item.individualDescription.toLowerCase().indexOf(filter.individualDescription.toLowerCase()) > -1)
                            && (!filter.individualComments || item.individualComments.toLowerCase().indexOf(filter.individualComments.toLowerCase()) > -1)
                            && (!filter.individualCreatedBy || item.individualCreatedBy.toLowerCase().indexOf(filter.individualCreatedBy.toLowerCase()) > -1)
                            && (!filter.individualDateCreated || item.individualDateCreated.indexOf(filter.individualDateCreated) > -1)
