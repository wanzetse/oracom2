$(function () {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            profiles.unshift({ Id: "0", ProfileName: "" });
            ...
            $("#jsGrid").jsGrid({
                ...
                fields: [
                    ...
                    {name: "mid_name", title: "MiddleName", type: "text", width: 100, filtering: false,validate:"required"},
                    {name: "last_name", title: "LastName", type: "text", width: 100,validate:"required"},
                    {name: "mobile_number", title: "PhoneNumber", type: "text", width: 100,validate: { message: "Phone Number Must be Specified", validator: function(value) {
                                var phone_no = /^\d{10}$/;
                        return phone_no.test(String(value).toLowerCase()); } }},
                    {name: "email", title: "Email", type: "text", width: 120,validate: { message: "Email Must be Specified", validator: function(value) {
                        ...
                        return re.test(String(value).toLowerCase()); } }},
                    {
                        ...
                        validate: { message: "Profile Must be Specified", validator: function(value) { return value > 0; } }
                    },
                    {
                        name: "BranchId",
                        title: "Branch",
